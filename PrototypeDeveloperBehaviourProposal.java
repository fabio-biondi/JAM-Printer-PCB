...
public class PrototypeDeveloperBehaviourProposal extends JAMWhileBehaviour {
    private LogFile log;
    public PrototypeDeveloperBehaviourProposal(JAMAgent myAgent) {
        super(myAgent);
        log = new LogFile();
    }
    /**
    ...
    public void action() throws JAMBehaviourInterruptedException {
        try  {
            ...
            Message request = new Message(
                ...
                "Puoi stampare uno schema elettrico su circuito PCB?"
            );
            ...
            if(answer.getPerformative() != Performative.AGREE) {
                ...
                Message confirm = new Message(
                    ...
                    "Stampa schema elettrico di un prototipo sviluppato da me." 
                    //accertata la possibilità di stampare un PCB, propongo un mio progetto da scheda di prototipazione
                );
